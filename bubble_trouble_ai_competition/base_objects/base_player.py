...
from bubble_trouble_ai_competition.utils.constants import Directions, DisplayConstants, Events, Settings, PowerupsSettings, ArrowColors, ALL_ARROW_COLORS
...
class BasePlayer:
    ...
    def __init__(self, name: str, direction: Directions, events_observable: EventsObservable,
        ...
        self.arrow_color: ArrowColors = random.choice(ALL_ARROW_COLORS)
