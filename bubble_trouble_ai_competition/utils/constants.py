...
powerup_constants_to_update = ['FLASH_SUIT_WIDTH', 'FLASH_SUIT_SHIFT_X', 'FLASH_SUIT_HEIGHT', 'FLASH_SUIT_SHIFT_Y', 'ICE_CUBE_Y',
                                ...
                                'TELEPORT_HEIGHT', 'TELEPORT_WIDTH', 'TELEPORT_WIDTH_INCREASE', 'TELEPORT_Y_INCREASE', 'TELEPORT_Y',
                                'ACTIVE_TELEPORT_WIDTH', 'ACTIVE_TELEPORT_HEIGHT', 'ACTIVE_TELEPORT_DUCK_HEIGHT', 'SHIELD_SIZE_INCREASE', 'DUCK_FLASH_SUIT_HEIGHT']
